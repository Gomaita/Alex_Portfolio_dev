  ...
  return (
    <footer className="border-t border-white/10 bg-[#0b0d10] px-5 py-8 text-sm text-zinc-500">
      <div className="mx-auto flex max-w-7xl flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <p>Real-time assets, props and environments.</p>
      </div>
    </footer>
  )
}
...
function ThreeDLayout({ children }) {
  return (
    <div className="min-h-screen bg-[#0b0d10] bg-[radial-gradient(circle_at_12%_0%,rgba(56,189,248,0.16),transparent_28%),radial-gradient(circle_at_88%_10%,rgba(249,115,22,0.10),transparent_24%),linear-gradient(135deg,#0b0d10,#101318_52%,#07080a)] text-zinc-100">
      <ThreeDNavbar />
      <main>{children}</main>
      <ThreeDFooter />
    </div>
