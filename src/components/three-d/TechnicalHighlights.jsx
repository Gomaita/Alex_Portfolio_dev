...
function TechnicalHighlights({ project }) {
  ...
  return (
    <section className="rounded-[1.5rem] border border-white/[0.07] bg-[radial-gradient(circle_at_top_left,rgba(20,184,166,0.07),transparent_35%),#111214] p-5 shadow-2xl shadow-black/15 sm:p-6">
      <p className="text-[11px] font-bold uppercase tracking-[0.22em] text-teal-200/80">Technical</p>
      <h2 className="mt-1 text-2xl font-black tracking-tight text-zinc-100">Technical Highlights</h2>
      <div className="mt-5 grid gap-3 sm:grid-cols-2">
        {highlights.map((highlight) => (
          <div key={highlight} className="flex items-start gap-3 rounded-2xl border border-white/[0.08] bg-black/20 p-4 transition hover:-translate-y-0.5 hover:border-white/18 hover:bg-black/30">
            <CheckCircle2 className="mt-0.5 shrink-0 text-teal-200/80" size={17} />
