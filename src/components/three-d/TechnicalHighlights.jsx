...
function TechnicalHighlights({ project }) {
  ...
  return (
    <section className="rounded-2xl border border-white/10 bg-[radial-gradient(circle_at_top_left,rgba(19,175,240,0.12),transparent_35%),#15181d] p-5">
      <p className="text-[11px] font-bold uppercase tracking-[0.22em] text-[#13aff0]">Technical</p>
      <h2 className="mt-1 text-lg font-bold tracking-tight text-zinc-100">Technical Highlights</h2>
      <div className="mt-4 grid gap-2 sm:grid-cols-2">
        {highlights.map((highlight) => (
          <div key={highlight} className="flex items-start gap-3 rounded-xl border border-white/10 bg-black/20 p-3 transition hover:-translate-y-0.5 hover:border-emerald-300/30">
