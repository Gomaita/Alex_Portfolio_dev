...
export const threeDProjectsFallback = [
  {
    ...
    categories: ['Environment', 'Real-time Asset', 'Personal Project'],
    tags: ['PBR', 'environment art', 'procedural', 'real-time'],
    role: 'Environment art, composition, lighting',
    thumbnailUrl: '',
    heroImageUrl: '',
    images: [],
    tools: ['Blender', 'Substance 3D Painter', 'Substance 3D Designer', 'Unreal Engine'],
    softwareUsed: ['Blender', 'Substance 3D Painter', 'Substance 3D Designer', 'Unreal Engine'],
  ...
  },
  {
    ...
    year: '2026',
    category: 'Prop',
    categories: ['Prop', 'Real-time Asset', 'Breakdown'],
    tags: ['PBR', 'game-ready', 'low poly', 'baking'],
    role: 'Modeling, UVs, baking, texturing, presentation',
    thumbnailUrl: '',
    heroImageUrl: '',
    images: [],
    tools: ['Maya', 'ZBrush', 'Substance 3D Painter', 'Marmoset Toolbag'],
    softwareUsed: ['Maya', 'ZBrush', 'Substance 3D Painter', 'Marmoset Toolbag'],
