...
export const projects = [
  ...
  },
  {
    ...
    slug: 'nutricore',
    title: 'NutriCore',
    subtitle: 'Nutrition and training platform with user and admin views.',
    summary:
      'A professional SaaS-style demo for managing users, meal plans, workout routines and progress tracking with local demo persistence.',
    description:
      'NutriCore is a nutrition and training platform demo built to practice a more complete product experience. It includes a normal user area, an admin view, editable diet and workout templates, weight progress charts and session-free localStorage persistence.',
    ...
    skillsDemonstrated: [
      ...
      'User and admin role views',
      'Editable meal plan templates',
    ...
    technicalNotes:
      'The demo uses localStorage as a mock persistence layer. Diets, routines, users and progress records can be edited without a backend, which makes it safe to demo while still showing realistic product flows.',
    improvements: [
      'Real authentication',
